...
public class ConvertVideo {
    ...
    public static boolean convert(String inputPath, String outputPath, String ffmpegPath) {
        getPath(inputPath, outputPath, ffmpegPath);

        File output = new File(outputPath + "output.mp4");
        if (output.exists()) {
            output.delete();
        }
    ...
    public static void getPath(String inputPath, String outputPath, String ffmpegPath) {
...
//                    + outputPath + "a.flv");
    ...
    private static boolean processMp4(String oldfilepath) {
        ...
        command.add(outputPath + "output.mp4");
        try {
